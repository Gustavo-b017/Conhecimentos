...
> **O que é:** O DHCP (Dynamic Host Configuration Protocol) é um protocolo cliente-servidor que automatiza a alocação de endereços lógicos ([[Rede_IP]]), máscaras de [[Rede_Subnetting]], gateways e servidores [[Rede_DNS]] para dispositivos em uma rede.
