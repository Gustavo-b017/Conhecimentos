...
*   **Como Funciona:** Em vez de enviar pacotes suspeitos contra um [[Rede_Firewall]], o analista (ou atacante) extrai dados de registros públicos de DNS, varreduras do Shodan, repositórios esquecidos no GitHub, redes sociais de funcionários e metadados de PDFs públicos da empresa.
