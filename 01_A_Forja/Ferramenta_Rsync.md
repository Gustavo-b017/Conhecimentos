...
* **O Problema que Causa:** No gerenciamento de cópias de segurança (Backups), copiar 1 Terabyte de dados todo dia pela rede exauriria a banda e o tempo. O `rsync` resolve isso sincronizando apenas as alterações diárias em segundos.
