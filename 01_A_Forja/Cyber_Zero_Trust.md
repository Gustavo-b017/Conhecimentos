...
*   **Como Funciona:** Opera sob três pilares: **Verifique Explicitamente** (sempre exija [[Cyber_MFA]] e cheque a saúde do PC ([[Cyber_Endpoint_Security|Endpoint]])), **Use o Menor Privilégio** ([[Cyber_IAM]] restrito a Just-In-Time) e **Assuma a Violação** (assuma que o hacker já está na rede, logo, use [[Cyber_Microsegmentacao|micro-segmentação]] para impedi-lo de se mover).
