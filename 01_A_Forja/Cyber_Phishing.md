...
- **Visão Sênior (Vulnerabilidades/Escala):** Profissionais ingênuos confiam apenas em filtros de [[Cyber_Engenharia_Social_Spam|Anti-Spam]]. Ataques direcionados (*[[Cyber_Phishing_Spear|Spear Phishing]]*) ou focados em altos executivos (*[[Cyber_Phishing_Whaling|Whaling]]*) são cirurgicamente construídos com [[Cyber_OSINT]] e escapam de filtros de palavras-chave facilmente. A única defesa arquitetural inquebrável contra a entrega de senhas via Phishing é o [[Cyber_MFA|MFA]] (Multi-Factor Authentication) amarrado ao hardware ([[Cyber_Autenticacao_FIDO2|FIDO2]]) do modelo [[Cyber_Zero_Trust]].
