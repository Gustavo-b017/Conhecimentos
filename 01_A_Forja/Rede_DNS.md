...
*   **Como Funciona:** Ocorre na Camada 7 (Aplicação) primariamente via UDP porta 53 pela velocidade. O processo envolve dois atores principais:
    ...
    * **Authoritative Server:** O "dono da verdade". O servidor que guarda o registro oficial daquele domínio. Clientes descobrem o endereço do Resolver via [[Rede_DHCP]].
