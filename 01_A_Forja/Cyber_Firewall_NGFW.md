...
*   **Como Funciona:** Em vez de olhar apenas portas (ex: porta 80 ou 443), o NGFW executa DPI (Deep Packet Inspection), destrinchando o payload para identificar o exato aplicativo rodando. Ele sabe a diferença entre o usuário acessar o LinkedIn via HTTPS e o usuário tentar acessar o Facebook na mesma porta HTTPS.
