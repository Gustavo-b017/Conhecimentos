...
**O que é:** O Hoax (Boato) é uma categoria de [[Cyber_Engenharia_Social|engenharia social]] focada em espalhar mensagens fraudulentas ou falsos alarmes — sem carregar código malicioso técnico — com o único intuito de gerar confusão, pânico e desperdício de tempo e recursos entre os usuários.
...
*   **O Problema que Causa:** O ataque causa sobrecarga operacional (Negação de Serviço Humana). A equipe do SOC ([[Cyber_Monitoramento_Continuo|SOC]]) e o Helpdesk de TI perdem centenas de horas atendendo ligações de funcionários em pânico com um "vírus letal" que sequer existe, enquanto uma invasão real pode estar acontecendo de forma silenciosa por trás das cortinas.
*   **Visão Sênior (Vulnerabilidades/Escala):** Embora subestimado por técnicos puristas por não ter código embutido, o Hoax explora a confiança. Em um formato mais perigoso (Scam/[[Cyber_Phishing|Phishing]] manual), o boato finge ser um aviso da TI dizendo: "Seu sistema está infectado. Exclua a pasta System32 imediatamente para se salvar". O próprio usuário destrói a máquina obedecendo a uma ordem falsa.
