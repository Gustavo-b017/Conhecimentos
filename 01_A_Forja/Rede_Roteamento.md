...
**O que é:** Roteamento é o processo de decisão algorítmica pelo qual roteadores (Camada 3) trocam mapas e calculam ativamente a rota mais rápida e eficiente para entregar pacotes de IP de uma rede origem até uma rede destino.
...
*   **Roteamento Dinâmico (IGP):** Roteadores de uma mesma empresa conversam usando protocolos como **OSPF** ou **EIGRP**. Eles desenham o mapa inteiro sozinhos e, se um link cair, eles recalculam a rota em milissegundos.
*   **Roteamento Global (EGP - Protocolo BGP):** É o roteamento que sustenta a internet. Em vez de achar o cabo mais rápido, o BGP acha o "Provedor" mais eficiente. 
