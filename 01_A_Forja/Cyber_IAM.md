...
A Gestão de Identidades começou nos anos 90 puramente para conectar computadores em um escritório fechado, consolidada pelo lançamento do _Active Directory_ (AD) da Microsoft no Windows 2000. No entanto, com a explosão da adoção da computação em nuvem nos anos 2010, o antigo AD não conseguia controlar logins de funcionários usando celulares pessoais para acessar o Google Workspace na rua, forçando o nascimento da geração de Identidade como Serviço (IDaaS).