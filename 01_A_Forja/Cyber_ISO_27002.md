...
*   **Como Funciona:** Ela age como o menu de um restaurante de defesas. Se a sua análise de risco (pela [[Cyber_ISO_27001|ISO 27001]]) diz que invasões de rede são um perigo crítico, você abre a ISO 27002 no "Controle 8.20 (Network Security)" ou "Controle 8.21 (Security of Network Services)" e ela te listará as melhores práticas de como arquitetar [[Rede_Firewall|firewalls]], [[Cyber_VPN_Mecanica|VPNs]] e segregação de ambientes.
