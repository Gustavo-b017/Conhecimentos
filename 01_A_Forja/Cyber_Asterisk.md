...
- **Visão Sênior (Vulnerabilidades/Escala):** Por ser extremamente flexível, o Asterisk não força autenticidade de origem. Um invasor usando um servidor Asterisk barato pode configurar o arquivo de plano de discagem (`extensions.conf`) para forjar o número de telefone que vai aparecer no visor do alvo ("Caller ID Spoofing"), simulando ser o suporte da Microsoft ou o banco da vítima.
