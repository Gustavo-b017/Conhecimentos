...
Conceito que ganhou força na última década com o avanço rápido das pesquisas quânticas, forçando órgãos como o [[Gov_NIST|NIST]] a acelerar os processos de padronização de novos algoritmos de criptografia para proteger infraestruturas contra agentes estatais que possuem capacidade massiva de armazenamento de dados