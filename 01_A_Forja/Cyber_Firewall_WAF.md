...
O *ModSecurity* é o WAF open-source mais famoso do mundo. Um exemplo de regra pragmática onde o WAF bloqueia qualquer requisição HTTP que tente injetar o comando clássico `1=1` (usado para explodir bancos de dados em SQLi):
```text
