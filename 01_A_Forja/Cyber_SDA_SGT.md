...
*   **Como Funciona:** O usuário se autentica na porta do switch (usando [[Rede_Protocolo_8021X|802.1X]]/MAB). O servidor de políticas (como o [[Ferramenta_Cisco_ISE|Cisco ISE]]) devolve uma Tag de 16 bits (SGT) representando o seu nível de acesso (ex: Tag 10 = RH, Tag 20 = IoT). O Switch injeta essa Tag no protocolo de encapsulamento **[[Rede_Protocolo_VXLAN|VXLAN-GPO]]**. Quando o pacote tenta acessar o servidor de Finanças, o switch de destino (Egress) lê a Tag e aplica a SGACL (Security Group ACL) bloqueando ou permitindo o acesso, sem nunca olhar para o [[Rede_IP]].
