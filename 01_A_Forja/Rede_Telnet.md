...
*   **Como Funciona:** Funciona de maneira puramente cliente-servidor usando uma conexão [[Rede_TCP]] sobre a porta 23 ([[Rede_TCP_Portas_e_Sockets]]), entregando um terminal de acesso remoto direto à máquina de destino.
