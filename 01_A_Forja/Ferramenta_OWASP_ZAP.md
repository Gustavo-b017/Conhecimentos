...
*   **Como Funciona:** Diferente do [[Ferramenta_Wireshark|Wireshark]] que lê cabos e portas de rede frias, o ZAP atua explicitamente como um homem-no-meio ([[Cyber_Man_In_The_Middle|Man-in-the-Middle]]) na camada de aplicação HTTP/HTTPS. Você configura seu navegador para passar por ele. O ZAP segura a requisição antes de enviá-la para o site, permitindo que você reescreva os campos para testar uma Injeção de [[Cyber_Ataque_SQL_Injection|SQL]] ou adulterar o seu cookie de administrador.
