...
*   **Como Funciona:** Diferente do SYN Flood que busca exaustão, o invasor aqui escuta o tráfego ou adivinha os números de sequência e forja um pacote RST passando-se por uma das partes da comunicação. Quando o alvo recebe o pacote, a pilha TCP obedece cegamente a regra da flag RST e encerra a conexão, fazendo com que a aplicação caia e tente se reconectar em loop.
