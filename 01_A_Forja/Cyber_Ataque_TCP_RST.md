...
*   **Como Funciona:** Diferente do [[Cyber_Ataque_DDoS_SYN_Flood|SYN Flood]] que busca exaustão, o invasor aqui escuta o tráfego ([[Cyber_Eavesdropping]]) ou adivinha os números de sequência e forja um pacote RST passando-se por uma das partes da comunicação (um tipo de [[Cyber_Man_In_The_Middle]] momentâneo). Quando o alvo recebe o pacote, a pilha [[Rede_TCP|TCP]] obedece cegamente a regra da [[Rede_TCP_Flags_e_Header|flag RST]] e encerra a conexão, fazendo com que a aplicação caia e tente se reconectar em loop.
