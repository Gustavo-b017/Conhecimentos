...
*   **O Problema que Resolve:** Elimina o *Boilerplate* da fiação manual. Sem o Autowired, inicializar um [[Java_Rest_Controller|Controlador]] exigiria instanciar o Serviço que, por sua vez, exigiria instanciar o Repositório, gerando um cascateamento de código infinito.
