...
- **O Problema que Resolve:** Para o atacante, resolve o bloqueio imposto por listas de controle de acesso (ACLs) do [[Rede_Firewall]] (ou [[Cyber_Firewall_PacketFilter]]) e facilita o redirecionamento de tráfego ([[Cyber_Man_In_The_Middle]]) sem disparar alarmes primários.
