...
O CIS Control 1 (Inventário e Controle de Ativos de Redes) não é preenchido com planilhas de Excel. Um profissional executa isso mapeando ativamente a infraestrutura para descobrir o que está ligado na sombra usando ferramentas do laboratório (Aula 5) como o [[Ferramenta_Nmap|Nmap]]:
```bash
