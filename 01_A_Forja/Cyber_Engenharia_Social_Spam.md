...
*   **Como Funciona:** Atacantes compram bancos de dados vazados ([[Cyber_OSINT]]) na Dark Web contendo milhões de endereços de e-mails. Eles alugam servidores de envio ou formam botnets ([[Cyber_IoT_Security|IoT]]) e disparam milhões de e-mails usando infraestrutura barata. 
