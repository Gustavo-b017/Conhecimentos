...
* **O Problema que Resolve:** Destrói a adivinhação. Quando ocorre um incidente de rede ou ataque, o log do servidor muitas vezes é insuficiente. O Wireshark fornece o "cadáver" real da conexão. Permite extrair a [[Ferramenta_Wireshark_Protocol_Hierarchy|hierarquia de protocolos]], provando matematicamente o momento em que uma falha ou envio anômalo começou [3].
...
O uso do [[Ferramenta_Wireshark]] equivale à **Cena de Crime Isolada para Perícia Criminal**. Sem ele, a TI apenas ouve testemunhas dizendo "A rede caiu". Com ele, a placa de rede varre o chão atrás de sangue. A aba de [[Ferramenta_Wireshark_Protocol_Hierarchy|Protocol Hierarchy]] te diz qual tipo de arma foi usada. A aba de [[Ferramenta_Wireshark_Endpoints|Endpoints]] mostra as pegadas dos criminosos e das vítimas na sala. A aba [[Ferramenta_Wireshark_Packet_Lengths|Packet Lengths]] mostra o calibre da munição, enquanto o [[Ferramenta_Wireshark_Flow_Graph|Flow Graph]] reconstrói a trajetória da bala frame a frame, ilustrando perfeitamente se um [[Cyber_Ataque_DDoS_SYN_Flood]] parou ou continuou de forma anômala.
