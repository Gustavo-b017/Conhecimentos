...
A implementação em servidores Linux para proteger o acesso [[Cyber_Malware_Backdoor|SSH]] exige a instalação do módulo PAM (Pluggable Authentication Module) do Google Authenticator.
```bash
