...
- **O Problema que Resolve:** Destrói a caótica [[Arquitetura_Ponto_a_Ponto]]. Impõe governança, reutilização de código e rastreabilidade para megacorporações que possuem centenas de sistemas legados que precisam interoperar.
...
O SOA atua como a **União Europeia no seu início burocrático**. Antes, os países (sistemas) guerreavam (acoplamento espaguete). O SOA cria um Parlamento Central e uma moeda única. Todos podem conversar e fazer comércio (reutilização de serviços), mas para importar um queijo da França para a Alemanha, você é obrigado a preencher um formulário alfandegário de 10 páginas (Protocolo SOAP) carimbado pela central. É extremamente seguro e auditável, mas mortalmente lento para um mundo ágil.
...
SOA surgiu no fim dos anos 1990 e dominou a década de 2000. Foi a bala de prata vendida por consultorias como Gartner e empresas como IBM e Oracle. O objetivo financeiro real não era "melhorar o código", mas sim vender caríssimas plataformas de integração (Middlewares) para os bancos e governos, permitindo que seus velhos mainframes COBOL conversassem com os novos portais web em Java.