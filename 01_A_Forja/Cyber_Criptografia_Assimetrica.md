...
A fundação de todo acesso remoto seguro em nuvem. A geração clássica de um par de chaves assimétricas usando o terminal Linux para poder se logar via SSH num servidor AWS sem nunca trafegar senhas em texto puro:
```bash
