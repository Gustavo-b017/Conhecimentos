...
**O que é:** Portas são identificadores numéricos virtuais (0 a 65535) na Camada 4. Um *Socket* é a fusão estrita de um Endereço IP com um Número de Porta (ex: `192.168.1.5:80`), identificando de forma única uma ponta exata de uma conexão.
