...
*   **Como Funciona:** Emprega gatilhos emocionais (Urgência, Autoridade, Medo, Ganância ou Confiança). O atacante frauda a própria identidade (Spoofing visual/vocal) e interage via e-mail (*[[Cyber_Phishing|Phishing]]*), telefone (*[[Cyber_Vishing|Vishing]]*) ou SMS (*[[Cyber_Smishing|Smishing]]*), convencendo o alvo de que está falando com o TI, com o chefe ou com o banco.
