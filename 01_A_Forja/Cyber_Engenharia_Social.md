...
*   **Como Funciona:** Emprega gatilhos emocionais (Urgência, Autoridade, Medo, Ganância ou Confiança). O atacante frauda a própria identidade (Spoofing visual/vocal) e interage via e-mail (*Phishing*), telefone (*Vishing*) ou SMS (*Smishing*), convencendo o alvo de que está falando com o TI, com o chefe ou com o banco.
...
*   **Visão Sênior (Vulnerabilidades/Escala):** O ser humano não possui pacote de atualização (Patch). Treinamentos de conscientização mitigam o risco, mas não o eliminam. A única arquitetura sênior capaz de resistir a um ataque de engenharia social bem-sucedido é a adoção brutal do [[Cyber_Zero_Trust]]: mesmo que o funcionário entregue a senha, o acesso é negado pois o sistema exige um token de hardware de Múltiplo Fator de Autenticação (MFA) e valida a geolocalização.

#### 3. As Sinapses (Conexões Livres e Interdisciplinares)
A [[Cyber_Engenharia_Social]] é exatamente o conceito do **Cavalo de Tróia de Homero** aplicado à era da informação. Os gregos perceberam que a muralha de Tróia (O [[Rede_Firewall]]) era impenetrável pela força bruta. Eles apelaram para o viés de vaidade e religiosidade dos troianos, deixando um "presente" de madeira no portão. Os troianos, manipulados cognitivamente, abriram as próprias portas e arrastaram a aniquilação para dentro da cidade com as próprias mãos. Na TI, o cavalo de madeira é um e-mail com o assunto "Aumento de Salário.pdf".
