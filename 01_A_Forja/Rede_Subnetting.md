...
**O que é:** Subnetting é a técnica cirúrgica de fatiar uma grande rede lógica de IP em pedaços menores, isolados e eficientes, manipulando os bits da Máscara de Sub-rede para definir exatamente onde termina o endereço da "Rede" e onde começa o endereço do "Host".
